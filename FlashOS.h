...
#define SECTOR_SIZE 0x10000    // Sector size
#define MUTI_ERASE 32          // 同时擦除扇区大小
#define PAGE_MAX   65536       // Max Page Size for Programming

#define USE_NATIVE_VERIFY 0    //使用内部校验算法,上位机会下发要校验的地址和数据;
#define USE_CRC_VERIFY    0    //使用硬件CRC取代字节对比
